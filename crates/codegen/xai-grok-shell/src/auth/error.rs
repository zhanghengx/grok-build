...
pub enum AuthError {
    ...
    #[error("API key is invalid or rejected. Set a valid api_key or env_key in ~/.grok/config.toml.")]
    ...
    #[error("API key authentication failed after all retries. Verify your api_key or env_key in ~/.grok/config.toml.")]
    RecoveryExhausted,
    ...
    #[error("API key authentication is disabled by your administrator. Contact your administrator.")]
    ApiKeyAuthDisabled,
