...
use super::auth::{
    dispatch_cancel_login, dispatch_login, dispatch_logout, dispatch_submit_api_configuration,
...
pub(crate) fn dispatch(action: Action, app: &mut AppView) -> Vec<Effect> {
    ...
    let effects = match action {
        ...
        Action::SubmitApiConfiguration => dispatch_submit_api_configuration(app),
        Action::CopyAuthUrl => {
